...
public class ServiceManagerWithoutDCRandWithoutSessionMap implements JavaService2 {
	...
	public Object invoke(String methodName, Object[] inputParams, DataControllerRequest request,
		...
		ServiceRequest serviceRequest = InvokeMockService
				.getServiceRequestwithoutSessionMapandwithoutDCR(request, "sessionjavaservice", "sessiongetservice", null, null,
