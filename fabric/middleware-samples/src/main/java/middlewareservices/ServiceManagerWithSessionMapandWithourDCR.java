...
public class ServiceManagerWithSessionMapandWithourDCR  implements JavaService2 {
	...
	public Object invoke(String methodName, Object[] inputParams, DataControllerRequest request,
		...
		ServiceRequest serviceRequest = InvokeMockService
				.getServiceRequestwithSessionMapandWithoutDCR(request, "sessionjavaservice", "sessiongetservice", null, null,
